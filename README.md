...
**Описание:** Scatter tenure vs churn probability, отток по типу контракта, матрица риска по сегментам

**Страница 3** - At-Risk customers  
**Описание:** Таблица с условным форматированием, фильтры по порогу вероятности и типу контракта
